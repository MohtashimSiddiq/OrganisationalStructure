    ...
    public partial class IntialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OrgRoles", t => t.RoleId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OrgRoles", t => t.ParentRoleId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Employees", "RoleId", "dbo.OrgRoles");
            DropForeignKey("dbo.OrgRoles", "ParentRoleId", "dbo.OrgRoles");
            ...
            DropIndex("dbo.OrgRoles", new[] { "ParentRoleId" });
